...
export const MODAL_SHOES = 'MODAL_SHOES',
  MODAL_INTERVALS_RUN = 'MODAL_INTERVALS_RUN',
  MODAL_INTERVALS_RUN_CROSS_TRAIN = 'MODAL_INTERVALS_RUN_CROSS_TRAIN',
  MODAL_STEADY_STATE_RUN = 'MODAL_STEADY_STATE_RUN',
  MODAL_STEADY_STATE_RUN_CROSS_TRAIN = 'MODAL_STEADY_STATE_RUN_CROSS_TRAIN',
