      ...
      ({handleDelete, handleEdit}) => {
        return (
          <tr className="activity-cross-train">
            ...
            <td className="data-icons"><span className="glyphicon glyphicon-road inactive"/> <span className="glyphicon glyphicon-apple inactive"/></td>
            <td className="data-category"><span className="value">Change Shoes</span></td>
